...
<?php
	add_filter('admin_footer_text', function() {
			$ns_plugin_name = 'NS Adblock Blocker';
			$ns_plugin_slug = 'ns-adblock-blocker';
			return 'If you like <strong>'.$ns_plugin_name.'</strong> please leave us a <a href="https://wordpress.org/support/plugin/'.$ns_plugin_slug.'/reviews?rate=5#new-post" target="_blank" class="wc-rating-link" data-rated="Thanks :)">★★★★★</a> rating. A huge thanks in advance!';
		}, 9999);	
?>